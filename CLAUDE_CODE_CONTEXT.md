...
**`PredefinedTaskType`** enum values: `Move`, `Split`, `Combine`, `Reverse`,
...
(`Reverse` was named `Walking` before schemaVersion 2, then briefly
`Setback` during the rename - a shunting-unit reversal, not a
staff/facility concept.)
